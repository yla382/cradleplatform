    ...
    <div class="content-container">
        ...
        <div class="content-body">
            <div class="table-container">
                <input type="button" class="btn-generic" onclick="location.href='${pageContext.request.contextPath}/patient/addPatient';" value="Create Patient" />
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/patient/editPatient" method="post">
                                    ...
                                    <button type="submit" value="submit"
                                            class="glyphicon glyphicon-pencil table-icon btn-no-style"
                                            title="Edit"></button>
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/patient/delete" method="post">
                                    ...
                                    <input type="hidden" name="location" value=${patient.location}>
                                    <button type="submit" value="submit"
                                            class="glyphicon glyphicon-trash table-icon btn-no-style"
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/reading/all/${patient.patientId}"
                                      method="get">
                                    <button type="submit" value="submit"
                                            class="glyphicon glyphicon-signal table-icon btn-no-style"
