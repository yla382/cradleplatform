...
<div class="content-container">
    ...
    <div class="add-patient-container">
        <div class="form-group row">
            ...
            <div class="col-sm-8"><%= patient.getAttestationID()%>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3">First Name:</div>
            <div class="col-sm-8"><%= patient.getFirstName()%>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3">Last Name:</div>
            <div class="col-sm-8"><%= patient.getLastName()%>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3">Country:</div>
            <div class="col-sm-9"><%= patient.getCountry()%>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3">Location:</div>
            <div class="col-sm-9"><%= patient.getLocation()%>
            </div>
        </div>
        <div class="row">
            <form id="submit" action="${pageContext.request.contextPath}/patient/submitPatient" method="post">
                ...
                <button type="submit" onclick="return true" class="btn-save">
                    Save
                </button>
