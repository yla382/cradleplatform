...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <c:forEach items="<%=readingList%>" var = "reading" varStatus="index">
            <tr>
                <th>${reading.firstName}</th>
                <td>${reading.lastName}</td>
                <td>${reading.ageYears}</td>
                <td>
                    <c:if test="${empty reading.symptoms}">
                        No Symptoms (patient healthy)
                    </c:if>
                    <c:if test="${not empty reading.symptoms}">
                        <c:forEach items="${reading.symptoms}" var = "symptoms">
                            ${symptoms}
                            <br>
                        </c:forEach>
                    </c:if>
