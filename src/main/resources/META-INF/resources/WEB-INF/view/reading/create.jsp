                    ...
                    <form action="${pageContext.request.contextPath}/reading/analysis"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 row">
                                <label for="readingId" class="col-md-4 col-form-label create-reading-label">READING
                                    ID</label>
                                <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 row">
                                <label for="firstName" class="col-sm-4 col-form-label create-reading-label">FIRST
                                    NAME</label>
                                <div class="col-sm-7">
                                    <input type="text" id="firstName" class="reading-field" name="firstName"
                            ...
                            <div class="col-sm-6 row">
                                <label for="lastName" class="col-sm-4 offset-sm-1 col-form-label create-reading-label">LAST
                                    NAME</label>
                                <div class="col-sm-7">
                                    <input type="text" id="lastName" class="reading-field" name="lastName"
