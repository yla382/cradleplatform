                    ...
                    <form action="${pageContext.request.contextPath}/reading/analysis"
                            ...
                            <div class="col-sm-6 row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input hidden required type="text" class="form-control" id="lastName"
                                           name="firstName" value="<%=reading.lastName%>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="ageYears" class="reading-field" name="ageYears"
                                           placeholder="Age" value="<%=reading.ageYears%>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 row">
                                <label for="gestationalAgeValue" class="col-sm-4 col-form-label create-reading-label">GESTATIONAL
                                    AGE</label>
                                <div class="col-sm-7">
                                    <input type="text" id="gestationalAgeValue" class="reading-field"
                                           name="gestationalAgeValue" placeholder="Gestational Age">
                                </div>
                            </div>
                            <div class="col-sm-6 row">
                                <label for="gestationalAgeUnit"
                        ...
                        <div class="form-group row" style="margin-top: 50px;">
                            <div class="col-sm-4 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="bpSystolic" class="reading-field" name="bpSystolic"
                                           placeholder="Systolic" value="<%=reading.bpSystolic%>">
                                </div>
                            </div>
                            <div class="col-sm-4 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="bpDiastolic" class="reading-field" name="bpDiastolic"
                                           placeholder="Diastolic" value="<%=reading.bpDiastolic%>">
                                </div>
                            </div>
                            <div class="col-sm-4 row">
                                <label for="heartRateBPM"
                                    ...
                                    RATE</label>
                                <div class="col-sm-6">
                                    <input type="text" id="heartRateBPM" class="reading-field" name="heartRateBPM"
                                           placeholder="Heart Rate" value="<%=reading.heartRateBPM%>">
                                </div>
                            </div>
                        </div>
