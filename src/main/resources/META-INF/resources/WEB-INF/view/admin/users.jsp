                        ...
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/admin/users/${user.userId}"
                                   class="glyphicon glyphicon-pencil table-icon" title="Edit"></a>
                            </td>
                            <td>
                                <a href="/admin/users/contact?userId=${user.userId}&name=${user.firstName} + ${user.lastName}"
                                   class="glyphicon glyphicon-envelope table-icon" title="Contact person"></a>
