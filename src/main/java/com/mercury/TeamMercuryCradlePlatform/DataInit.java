...
public class DataInit implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Patient patient1 = new Patient("48300027402","Ricky", "Owen",21,"Uganda", "VillageA");
        Patient patient2 = new Patient("00159694421","Bobby", "Frown", 32,"Uganda", "VillageA");
        Patient patient3 = new Patient("392310","Braum", "Gloss", 24,"Uganda", "VillageB");
        Patient patient4 = new Patient("323494760911189","Bro", "Ther", 31,"Uganda", "VillageB");
